...
Power BI + Python retail analytics on Kaggle Superstore dataset | 9,800 rows · Sales · Customers · Products · Shipping | DAX · Power Query · EDA
...
West region leads in sales — generating $0.71M, outperforming East ($0.67M), Central ($0.49M), and South ($0.39M).
Consumer segment dominates — accounting for $1.15M (51%) of total sales, followed by Corporate ($0.69M) and Home Office ($0.42M).
Technology is the top category — at $0.83M, slightly ahead of Furniture ($0.73M) and Office Supplies ($0.71M).
Phones lead sub-categories — at $0.33M, followed closely by Chairs ($0.32M).
Standard Class is the most used shipping mode — handling 2,945 orders (60%) but also the slowest at 5 days average.
Same Day delivery is fastest — averaging less than 1 day, while Standard Class averages 5 days.
Average shipping time is 4 days — indicating room for improvement in last-mile delivery efficiency.
Zebra ZM400 Thermal Label Printer is the top product — generating $7K in sales, significantly ahead of other products.
---
🧠 Lessons Learned
